...
void solve() {
    ...
    for(char ch : s){        
        if (ch == '[' or ch == '(' or ch == '{'){
            ...
            if (ch == ')' and brackets.top() == '(') brackets.pop();
            else if (ch == '}' and brackets.top() == '{') brackets.pop();
            else if (ch == ']' and brackets.top() == '[') brackets.pop();
            else { cout << "DEU RUIM" << endl; return; }
        } else {
            cout << "DEU RUIM" << endl; 
            return;
        } 
    }
    brackets.empty() ? cout << "COMPLETINHA" << endl : cout << "DEU RUIM" << endl;
}
int main() {
